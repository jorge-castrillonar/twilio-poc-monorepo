 ...
 * Uses Base UI Button for close action
 */
    ...
    >
      <div className="flex">
        ...
        <div className="ml-3 flex-1">
          ...
          <div className={`text-sm ${title ? 'mt-1' : ''} ${style.text}`}>
            {message}
          </div>
        </div>
        {onClose && (
          <div className="ml-auto pl-3">
            <Button
              onClick={onClose}
              className={`inline-flex rounded-md p-1.5 focus:outline-none focus:ring-2 focus:ring-offset-2 ${style.icon} hover:bg-opacity-20`}
            >
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
                <path
                  fillRule="evenodd"
